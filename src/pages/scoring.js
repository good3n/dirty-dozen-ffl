...
const ScoringPage = () => (
  <Layout>
    <SEO title="Scoring" />
    <h1>Scoring <span style={{ fontWeight: `400`, color: `#999` }}>(Unofficial)</span></h1>
    <Table>

      <h3>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460.01 460.01" style={{ top: `9px`, fill: `#4299e1` }}>
      ...
      <h3>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 396.33 396.33" style={{ top: `7px`, fill: `#38b2ac` }}>
      ...
      <h3>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125" style={{ top: `17px`, fill: `#f56565` }}>
